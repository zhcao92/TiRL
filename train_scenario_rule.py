...
save_path="/home/icv/Trustworth/stable-baselines/models/sac_rule3"



env = CarEnv(random_env = True)
...
model.learn(total_timesteps=500000, rule_based_training=True, rule_based_planner=IDM(env))
